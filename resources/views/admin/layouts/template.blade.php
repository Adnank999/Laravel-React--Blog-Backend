                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
                                    ...
                                    <span class="side-menu__label">Poll</span><i class="fa-solid fa-blog"></i></a>


                                <ul class="slide-menu">

                                    <li class="side-menu-label1"><a href="javascript:void(0)">Poll</a></li>
                                    <li><a class="slide-item" href="{{Route('poll.store')}}"><span>Create Polls</span></a></li>
                                    <li><a class="slide-item" href="{{Route('poll.index')}}"><span>Show Polls</span></a></li>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="row text-center">
                                            <div class="col-md-12">
                                                <img src="../assets/images/photos/award.png" alt="img" class="sales-img">
                                        ...
                                        <div class="scrollbar h-400" id="scrollbar">
                                            <div class="d-flex mb-5">
                                                <a href="javascript:void(0)" class="me-4">
                                                    <img class="w-8 h-8 rounded shadow" src="../assets/images/orders/1.jpg" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                            ...
                                            <div class="d-flex mb-5">
                                                <a href="javascript:void(0)" class="me-4">
                                                    <img class="w-8 h-8 rounded shadow" src="../assets/images/orders/2.jpg" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                            ...
                                            <div class="d-flex mb-5">
                                                <a href="javascript:void(0)" class="me-4">
                                                    <img class="w-8 h-8 rounded shadow" src="../assets/images/orders/3.jpg" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                            ...
                                            <div class="d-flex mb-5">
                                                <a href="javascript:void(0)" class="me-4">
                                                    <img class="w-8 h-8 rounded shadow" src="../assets/images/orders/4.jpg" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                            ...
                                            <div class="d-flex mb-5">
                                                <a href="javascript:void(0)" class="me-4">
                                                    <img class="w-8 h-8 rounded shadow" src="../assets/images/orders/5.jpg" alt="media1">
                                                </a>
                                                <div class="mt-3">
                                        ...
                                        <div class="h-400 scrollbar2" id="scrollbar2">
                                            <div class="table-responsive">
                                                <table class="table transaction-table mb-0 text-nowrap">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow me-3" src="../assets/images/orders/7.jpg" alt="media1"> New Book</td>
                                                            <td>#12323423</td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow me-3" src="../assets/images/orders/8.jpg" alt="media1"> New Bowl</td>
                                                            <td>#26762768</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow me-3" src="../assets/images/orders/9.jpg" alt="media1"> Modal Car</td>
                                                            <td>#76273277</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span class="badge bg-primary rounded-pill">Completed</span></td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow me-3" src="../assets/images/orders/10.jpg" alt="media1"> Headset</td>
                                                            <td>#67237267</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow me-3" src="../assets/images/orders/11.jpg" alt="media1"> New Headset</td>
                                                            <td>#561527167</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span class="badge bg-danger rounded-pill">Declined</span></td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow me-3" src="../assets/images/orders/12.jpg" alt="media1"> Watch</td>
                                                            <td>#12323423</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span class="badge bg-primary rounded-pill">Completed</span></td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow me-3" src="../assets/images/orders/13.jpg" alt="media1"> Branded Shoes</td>
                                                            <td>#26762768</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span class="badge bg-warning rounded-pill">Pending</span></td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow me-3" src="../assets/images/orders/14.jpg" alt="media1"> New Modal shoe</td>
                                                            <td>#12323423</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span class="badge bg-primary rounded-pill">Completed</span></td>
                                                        ...
                                                        <tr>
                                                            <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow me-3" src="../assets/images/orders/5.jpg" alt="media1"> Branded Shoes</td>
                                                            <td>#26762768</td>
                                                            <td>11th July, 10am</td>
                                                            <td class="font-weight-bold">$13,206</td>
                                                            <td><span class="badge bg-warning rounded-pill">Pending</span></td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table transaction-table mb-0">
                                                    <tbody>
                                                        <tr>
                                                            <td class="d-flex">
                                                                <img class="w-7 h-7 rounded shadow me-3" src="../assets/images/users/1.jpg" alt="media1">
                                                                <div class="mt-2">
                                                        ...
                                                        <tr>
                                                            <td class="d-flex">
                                                                <img class="w-7 h-7 rounded shadow me-3" src="../assets/images/users/4.jpg" alt="media1">
                                                                <div class="mt-2">
                                                        ...
                                                        <tr>
                                                            <td class="d-flex">
                                                                <img class="w-7 h-7 rounded shadow me-3" src="../assets/images/users/5.jpg" alt="media1">
                                                                <div class="mt-2">
                                                        ...
                                                        <tr>
                                                            <td class="d-flex">
                                                                <img class="w-7 h-7 rounded shadow me-3" src="../assets/images/users/2.jpg" alt="media1">
                                                                <div class="mt-2">
                                                        ...
                                                        <tr>
                                                            <td class="d-flex">
                                                                <img class="w-7 h-7 rounded shadow me-3" src="../assets/images/users/10.jpg" alt="media1">
                                                                <div class="mt-2">
                                                        ...
                                                        <tr>
                                                            <td class="d-flex">
                                                                <img class="w-7 h-7 rounded shadow me-3" src="../assets/images/users/12.jpg" alt="media1">
                                                                <div class="mt-2">
